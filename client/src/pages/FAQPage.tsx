      ...
      <main className="py-20">
        ...
        <section className="relative overflow-hidden mb-16">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
            ...
            <p
              ...
              style={{ color: "var(--faq-text)" }}
            >
              Explore clear, concise answers to common questions about the
              Nairobi DevOps Community — from membership and events to platform
              features and contribution opportunities.
            </p>
          </div>
        </section>
        ...
        <section className="transition-opacity duration-500 ease-out opacity-100">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            {faqDataByCategory.map((category, categoryIndex) => {
              const sectionBg =
                categoryBackgrounds[categoryIndex % categoryBackgrounds.length];
        ...
        >
          ...
          <Button
            ...
            onClick={() =>
              window.open("mailto:info@nairobidevops.org", "_self")
            }
          >
            Contact Us
          </Button>
