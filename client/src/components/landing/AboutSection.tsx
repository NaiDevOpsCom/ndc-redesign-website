        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-foreground dark:text-white">
            ...
            <p className="text-foreground dark:text-white leading-relaxed">
              As part of Nairobi’s growing tech ecosystem, we’re fostering
              inclusive learning, collaboration, and innovation among DevOps
              engineers, developers, designers, students, and tech enthusiasts
