      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Your privacy and data protection are important to us. This Privacy
            Policy explains how Nairobi DevOps Community ("we," "our," or "the
            Community") collects, uses, shares, and protects your personal data
            across all platforms, events, and services we operate. We are
            committed to compliance with applicable data protection laws,
            including Kenya's Data Protection Act (2019), the GDPR (where
            applicable), and other relevant standards.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Nairobi DevOps Community is a volunteer-led, open tech community
              founded in Nairobi, Kenya. We organize meetups, conferences,
              workshops, and online learning opportunities for individuals
              interested in DevOps, cloud computing, and related technologies.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed ml-4">
              <li>
                ...
                Full name, email address, phone number, gender (optional),
              ...
              <li>
                ...
                IP address, browser type, device type, location (general), and
              ...
              <li>
                ...
                Messages or queries you send us via email, forms, or social
                media.
              </li>
            </ul>
            <p className="text-muted-foreground mt-4 leading-relaxed">
              We do not intentionally collect data from minors under 18 without
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed ml-4">
              <li>
                ...
                When you opt-in to our newsletters or event communications
              </li>
              <li>
                <span className="font-semibold text-foreground">
                  Legitimate Interest{" "}
                </span>
                – To grow our community and improve user engagement
              </li>
              <li>
                <span className="font-semibold text-foreground">
                  Contractual Obligation{" "}
                </span>
                – To deliver services (e.g., event access or certificates)
              </li>
              <li>
                <span className="font-semibold text-foreground">
                  Legal Compliance{" "}
                </span>
                – For tax, audit, and safeguarding purposes
              </li>
            </ul>
            <p className="text-muted-foreground mt-4 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed ml-4">
              <li>
                Event partners and sponsors (non-sensitive data only, and with
                consent)
              </li>
              <li>
                Vendors or service providers helping us run events or manage our
                systems (e.g., Eventbrite, Google Forms, Zoom)
              </li>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Our website and event platforms may use cookies and similar
              technologies to:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed ml-4">
            ...
            <p className="text-muted-foreground mt-4 leading-relaxed">
              You can manage cookie settings in your browser. Some features may
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              In the event of a breach, we will notify affected individuals and
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed ml-4 mb-4">
              ...
              <li>
                File a complaint with the Office of the Data Protection
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our website or emails may link to third-party platforms (e.g.,
              Zoom, GitHub, Meetup). We are not responsible for the privacy
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We may update this Privacy Policy to reflect legal or operational
              changes. The latest version will always be available on our
              website with a "last updated" date. We encourage you to review it
              periodically.
            </p>
          </section>
